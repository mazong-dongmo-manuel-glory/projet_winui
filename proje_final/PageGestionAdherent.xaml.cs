...
namespace proje_final
{
    ...
    /// </summary>
    public sealed partial class PageGestionAdherent : Page
    {
        ObservableCollection<Adherent> adherentListes;
        public PageGestionAdherent()
        {
            this.InitializeComponent();
            adherentListes = Singleton.getInstance().adherentListe;
            gridAdherents.ItemsSource = adherentListes;
